...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    // console.log("Response from api in sign up",response)
    if (response.data.success === false) return updateNotification("error", response.data.message);
  ...
  return (
    <div className="bg-[#000000] bg-grid w-full h-full min-h-[100vh] flex flex-col justify-center items-center">
      <Box
        display="flex"
      ...
      >
        <Typography
          variant="h5"
          color={"orange"}
          className="px-3 text-center md:pt-0 pt-4 text-orange-500"
        >
      ...
      >
        <Typography
          variant="h5"
          color={"orange"}
          className="px-3 text-center md:pb-0 pb-4 text-orange-500"
        >
          Powered By CN_CUIET
        </Typography>
      </Box>
