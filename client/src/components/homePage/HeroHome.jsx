      ...
      <div className="flex flex-col justify-center items-center h-auto md:w-[60%] sm:w-[50%] w-[90%] md:gap-10 gap-5 md:py-20 py-10">
        ...
        <div className="flex flex-col justify-center items-center md:pt-10 pt-5">
          <button
            ...
            className="px-5 text-base md:text-lg font-semibold capitalize py-2 cursor-pointer shadow-md hover:shadow-lg transition-all duration-200 ease-in-out bg-orange-600 hover:bg-orange-700 rounded-[8px]"
          >
            {btn}
          </button>
        </div>
