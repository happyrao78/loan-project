...
const Description = ({ jobName, teamName }) => {
  ...
  return (
    <div className="flex bg-black bg-grid text-white flex-col justify-center items-center w-full h-auto px-10">
      <div className="flex flex-col md:w-[70%] w-[90%] justify-center items-start gap-8 py-14">
        <div className="flex flex-col justify-center items-center">
          <h1 className="lg:text-2xl md:text-xl sm:text-lg text-base font-semibold text-orange-500">
            Job Description
          </h1>
        </div>
        <div className="flex flex-col justify-center items-start gap-4">
          <h1 className="lg:text-xl md:text-lg sm:text-base text-sm font-semibold text-orange-500">
            About Us:
          </h1>
